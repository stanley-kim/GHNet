<div id="perio_st_schedule" class="khusd_st calendar list perio">

	<div class="title">
		<?php echo getDateFormat($st_date, 'Y')?>
		<span class="month"><?php echo getDateFormat($st_date, 'n')?></span>
	...
	<table class="calendar">
		<tbody>
			<tr class="navi">
				<td colspan="7">
					<a href="">◁지난달</a>
					<a href="<?php echo $g['khusd_st_perio_st_schedule'].$date['today']?>">|오늘|</a>
					<a href="">다음달▷</a>
				</td>
			</tr>
			...
			<?php for( ; getDateFormat($day, 'n') <= getDateFormat($st_date, 'n'); ):?>
			<tr class="day">
				<td class="sun">
			...
			<tr class="body">
				...
				<td class="weekday">
					<?php if(getDateFormat($day2, 'n') == getDateFormat($st_date, 'n')):?>
					<a href="<?php echo $g['khusd_st_perio_st_list'].$day2.'&amp;st_timetype=am'?>">오전 <?php echo $ST_CHAIR_ARRAY[$day2]['am']?>명</a>
					<br />
					<a href="<?php echo $g['khusd_st_perio_st_list'].$day2.'&amp;st_timetype=pm'?>">오후 <?php echo $ST_CHAIR_ARRAY[$day2]['pm']?>명</a>
					<?php $day2++?>
					<?php endif?>
				</td>
				<td class="weekday">
				...
				<td class="weekday">
					...
					<a href="<?php echo $g['khusd_st_perio_st_list'].$day2.'&amp;st_timetype=pm'?>">오후 <?php echo $ST_CHAIR_ARRAY[$day2]['pm']?>명</a>
					<br />
					<a href="<?php echo $g['khusd_st_perio_st_list'].$day2.'&amp;st_timetype=nt'?>">야간 <?php echo $ST_CHAIR_ARRAY[$day2]['nt']?>명</a>
					<?php $day2++?>
					<?php endif?>
				</td>
				<td class="weekday">
	...
	<table class="my_chair">
		<tbody>
			...
			<tr class="body">
				...
				<td><?php echo $d['khusd_st_cnslt_room_manager']['tx_plan']['perio'][$MY_ST_CHAIR['tx_plan']]['name']?></td>
