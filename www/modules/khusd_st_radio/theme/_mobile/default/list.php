...
<!--	<th scope="col" class="split"><a href="<?php echo getSortingLink($c, 'penalty_taking', $om)?>">Penalty Taking</a></th>
	...
	<th scope="col" class="split"><a href="<?php echo getSortingLink($c, 'obser_decoding', $om)?>">판독옵져</a></th>
	<th scope="col" class="split"><a href="<?php echo getSortingLink($c, 'obser_filming', $om)?>">촬영옵져</a></th>
