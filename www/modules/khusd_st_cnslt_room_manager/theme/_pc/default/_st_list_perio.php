<div id="perio_list" class="khusd_st calendar list perio">
	...
	<th scope="col" class="split"><a href="<?php echo getSortingLink2($g['khusd_st_cnslt_room_manager_st_perio_list'].$st_date.'&amp;st_timetype='.$st_timetype, 'status', $om, $order == 'status')?>">상태</a></th>
	<th scope="col" class="split"><a href="<?php echo getSortingLink2($g['khusd_st_cnslt_room_manager_st_perio_list'].$st_date.'&amp;st_timetype='.$st_timetype, 'chair_no', $om, $order == 'chair_no')?>">체어</a></th>
	<th scope="col" class="split"><a href="<?php echo getSortingLink2($g['khusd_st_cnslt_room_manager_st_perio_list'].$st_date.'&amp;st_timetype='.$st_timetype, 'tx_plan', $om, $order == 'tx_plan')?>">진료내용</a></th>
	<th scope="col" class="split"><a href="<?php echo getSortingLink2($g['khusd_st_cnslt_room_manager_st_perio_list'].$st_date.'&amp;st_timetype='.$st_timetype, 'st_id', $om, $order == 'st_id')?>">학생명</a></th>
	<th scope="col" class="split"><a href="<?php echo getSortingLink2($g['khusd_st_cnslt_room_manager_st_perio_list'].$st_date.'&amp;st_timetype='.$st_timetype, 'pt_name', $om, $order == 'pt_name')?>">환자명</a></th>
	<th scope="col" class="split"><a href="<?php echo getSortingLink2($g['khusd_st_cnslt_room_manager_st_perio_list'].$st_date.'&amp;st_timetype='.$st_timetype, 'stsc', $om, $order == 'stsc')?>">직전SC수</a></th>
	...
	<?php if($MANAGER):?>
	<td><?php echo $ST_CHAIR['sc_chair']?></td>
	<?php endif?>
