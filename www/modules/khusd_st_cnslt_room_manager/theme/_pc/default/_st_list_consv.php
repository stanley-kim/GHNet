<div id="consv_list" class="khusd_st calendar list consv">
	...
	<th scope="col" class="split"><a href="<?php echo getSortingLink2($g['khusd_st_cnslt_room_manager_st_consv_list'].$st_date.'&amp;st_timetype='.$st_timetype, 'status', $om, $order == 'status')?>">상태</a></th>
	<th scope="col" class="split"><a href="<?php echo getSortingLink2($g['khusd_st_cnslt_room_manager_st_consv_list'].$st_date.'&amp;st_timetype='.$st_timetype, 'chair_no', $om, $order == 'chair_no')?>">체어</a></th>
	<th scope="col" class="split"><a href="<?php echo getSortingLink2($g['khusd_st_cnslt_room_manager_st_consv_list'].$st_date.'&amp;st_timetype='.$st_timetype, 'tx_plan', $om, $order == 'tx_plan')?>">진료내용</a></th>
	...
	<th scope="col" class="split">OP+Inlay</th>
	...
	<form name="applyStChair" method="post" action="<?php echo $g['s']?>/" target="_action_frame_<?php echo $m?>">
		...
		<tbody>
			...
			<tr>
			<td class="head">예상OP수</td>
			<td>
				<input type="text" name="consv_op" maxlength="4" class="input" value="" />
			</td>
			</tr>
		</tbody>
		</table>
