...
//		." AND st.st_date LIKE '".substr($st_date, 0, 6)."%'";
	...
	$last_month_day = date('Ymd', mktime(0, 0, 0, getDateFormat($st_date, 'm') - 1, 1, getDateFormat($st_date, 'Y')));
	$next_month_day = date('Ymd', mktime(0, 0, 0, getDateFormat($st_date, 'm') + 1, 1, getDateFormat($st_date, 'Y')));
?>