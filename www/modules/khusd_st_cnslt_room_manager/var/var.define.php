...
$d['khusd_st_cnslt_room_manager']['pros']['inst'] = array(
	...
	'list' 			=> array(
			...
			'joo'		=> array( 'id' => 'joo', 	'name' => 'Dr.김주형' ),
			'oh'		=> array( 'id' => 'oh', 	'name' => 'Dr.오진아' ),
			'min'		=> array( 'id' => 'min', 	'name' => 'Dr.박민서' ),
                        'ha'		=> array( 'id' => 'ha', 	'name' => 'Dr.김하영' ),
			'son'		=> array( 'id' => 'son', 	'name' => 'Dr.손다흰' ),
			'shin'		=> array( 'id' => 'shin', 	'name' => 'Dr.신세준' ),
			'sung'		=> array( 'id' => 'sung', 	'name' => 'Dr.김성아' ),
