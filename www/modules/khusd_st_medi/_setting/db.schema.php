...
CREATE TABLE `".$table[$module.'score']."` (
  ...
  `charting_tmd_4cycle_charting` int(4) NOT NULL default 0,
  `charting_tmd_4cycle_check` int(4) NOT NULL default 0,
  `charting_tmd_4cycle_follow1st` int(4) NOT NULL default 0,
  `charting_tmd_4cycle_follow2nd` int(4) NOT NULL default 0,
