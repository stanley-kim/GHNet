<?php
	...
	*/
	...
	$_data = 'AVG(charting_obser) AS charting_obser, AVG(charting_tmd_1cycle_charting) AS charting_tmd_1cycle_charting, AVG(charting_tmd_2cycle_charting) AS charting_tmd_2cycle_charting, AVG(charting_tmd_3cycle_charting) AS charting_tmd_3cycle_charting,  AVG(charting_tmd_4cycle_charting) AS charting_tmd_4cycle_charting,  AVG(charting_soft_charting) AS charting_soft_charting, AVG(obser) AS obser, AVG(splint_obser) AS splint_obser, '
