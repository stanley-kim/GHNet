...
<!--		<tr>
		...
		<tr>
			<td>Infrared Lamp: <input type="number" name="infra_tx" maxlength="5" class="input num" value="<?php echo $SCORE['infra_tx']?>">회</td>
			<td>Ultrasound: <input type="number" name="ultra_tx" maxlength="5" class="input num" value="<?php echo $SCORE['ultra_tx']?>">회</td>		</tr>
		<tr>
			<td>EAST: <input type="number" name="east_tx" maxlength="5" class="input num" value="<?php echo $SCORE['east_tx']?>">회</td>
			<td>TENS: <input type="number" name="tens_tx" maxlength="5" class="input num" value="<?php echo $SCORE['tens_tx']?>">회</td>
		</tr>
		<tr>
			<td>Iontophoresis<input type="number" name="ionto_tx" maxlength="5" class="input num" value="<?php echo $SCORE['ionto_tx']?>">회</td>
			<td>TMD Soft Laser<input type="number" name="tmd_tx" maxlength="5" class="input num" value="<?php echo $SCORE['tmd_tx']?>">회</td>
		</tr>
		<tr>
			<td>연조직 Soft Laser <input type="number" name="soft_tx" maxlength="5" class="input num" value="<?php echo $SCORE['soft_tx']?>">회</td>
			<td>&nbsp;</td>
		</tr>
		</table>
			</td>
