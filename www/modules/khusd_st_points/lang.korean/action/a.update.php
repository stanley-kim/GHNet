...
// 입력한 데이터로 query 생성
$QKEY = "s_uid, st_id, charting, dressing, cp, simple_ext, surgical_ext, minor, major, st_case, st_assist, imp_1st, imp_2nd, date_update";
$QVAL = "'$s_uid', '$st_id', '$charting', '$dressing', '$cp', '$simple_ext', '$surgical_ext', '$minor', '$major', '$st_case', '$st_assist', '$imp_1st', '$imp_2nd', '$date_update'";
