		...
		<table class="my_follow update">
			...
			<tbody>
				...
				<tr class="follow_name">
					<td><?php echo $idx++?></td>
					<td><a href="#" onclick="find_pt_id('<?=$MY_FOLLOW['pt_id']?>');return false;" ><?php echo $MY_FOLLOW['pt_name']?></a></td>
					<td><a href="#" onclick="find_pt_id('<?=$MY_FOLLOW['pt_id']?>');return false;" ><?php echo $MY_FOLLOW['pt_id']?></a></td>
					<td>
					<?php foreach( $d['khusd_st_pros']['TYPES'] as $type ):?>
					...
					<td>
                        <span class="btn00"><a href="#" style="background-color:#3399DD;font-weight:bold;width:40px;color:white;"onclick="changeFollowStatus('<?php echo $MY_FOLLOW["fcuid"];?>');">저장</a></span>
                    </td>
				</tr>
