...
CREATE TABLE `".$table[$module.'score']."` (
  ...
  `simple_obser_4_1` int(4) NOT NULL default 0,
  `simple_obser_4_2` int(4) NOT NULL default 0,
  `simple_obser_4_3` int(4) NOT NULL default 0,
  `simple_obser_4_4` int(4) NOT NULL default 0,
  `simple_obser_4_5` int(4) NOT NULL default 0,
  `simple_obser_4_6` int(4) NOT NULL default 0,
  `simple_obser_4_7` int(4) NOT NULL default 0,
  `simple_obser_4_8` int(4) NOT NULL default 0,
  `simple_obser_4_1cycle` int(4) NOT NULL default 0,
  `simple_obser_4_2cycle` int(4) NOT NULL default 0,
  `simple_obser_4_3cycle` int(4) NOT NULL default 0,
  `simple_obser_4_4cycle` int(4) NOT NULL default 0,
