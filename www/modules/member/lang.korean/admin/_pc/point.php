...
<div id="pointlist">
	...
	<div class="info">
		...
		<div class="article">
			...
			<span class="tx">
			<a class="<?php if($type=='point'):?>b <?php endif?>hand" onclick="document.procForm.type.value='point';document.procForm.submit();">상벌점(H)</a> |
			<a class="<?php if($type=='cash'):?>b <?php endif?>hand" onclick="document.procForm.type.value='cash';document.procForm.submit();">상벌점(S)</a> |
