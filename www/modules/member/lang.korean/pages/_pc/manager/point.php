...
<div id="pointlist">
	...
	<div class="info">
		...
		<div class="article">
			...
			<span class="tx">
			<a class="<?php if($type=='point'):?>b <?php endif?>hand" onclick="document.hideForm.type.value='point';document.hideForm.submit();">상벌점(H)</a> |
			<a class="<?php if($type=='cash'):?>b <?php endif?>hand" onclick="document.hideForm.type.value='cash';document.hideForm.submit();">상벌점(S)</a> |
		...
		<div class="category">
			...
			<input type="text" name="price" size="5" class="input" /><?php echo 'P'?> | 지급사유 : 
...
document.title = "<?php echo $M[$_HS['nametype']]?>님의 상벌점(H)";
