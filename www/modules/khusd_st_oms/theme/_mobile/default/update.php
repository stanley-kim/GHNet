...
<!--		<td class="head">Charting</td>
		...
		<td><input type="number" name="fix" maxlength="5" class="input" value="<?php echo $SCORE['fix']?>">회</td>
		</tr>
<!--		<tr>
		<td class="head">E/R Call</td>
		<td><input type="number" name="er_call" maxlength="5" class="input" value="<?php echo $SCORE['er_call']?>">회</td>
		</tr>
-->		<tr>
		<td class="head">Implant</td>
...
<!--		<tr>
		...
		<td><input type="number" name="st_case" maxlength="5" class="input" value="<?php echo $SCORE['st_case']?>">개</td>
		</tr>
		<tr>
