<?php
	...
	*/
	...
	$_data = 'sc.*, '
			...
			.$_data_follow_score.' AS follow_score, '
			.$_data_obser_follow_score.' AS obser_follow_score, '
			.$_data_report_score.' AS report_score, '
	...
	// 평균 구하기
	$_data = 'AVG(obser) AS obser, AVG(obser_pt) AS obser_pt, '
			.'AVG(follow) AS follow, AVG(follow_pt) AS follow_pt, AVG(follow_report) AS follow_report, '
			.'AVG('.$_data_obser_score.') AS obser_score, '
			.'AVG('.$_data_follow_score.') AS follow_score, '
			.'AVG('.$_data_obser_follow_score.') AS obser_follow_score, '
			.'AVG('.$_data_report_score.') AS report_score, '
