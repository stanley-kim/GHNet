...
//		.', '.$_data_follow;
	...
	$_data = 'AVG(endo_molar) AS endo_molar, AVG(endo_pre) AS endo_pre, AVG(endo_ant) AS endo_ant'
		...
		.', AVG(pre_st_ant) AS pre_st_ant'
		.', AVG(pre_st_post) AS pre_st_post'
		.', AVG(pre_st_cervical) AS pre_st_cervical'
		.', AVG(pre_st_am) AS pre_st_am'
		.', AVG(pre_st_ant_pe) AS pre_st_ant_pe'
		.', AVG(pre_st_ant_ce) AS pre_st_ant_ce'
		.', AVG(pre_st_ant_cf) AS pre_st_ant_cf'
		.', AVG(pre_st_ant_re_rm) AS pre_st_ant_re_rm'
		.', AVG(pre_st_ant_re_ce) AS pre_st_ant_re_ce'
		.', AVG(pre_st_ant_re_cf) AS pre_st_ant_re_cf'
		.', AVG(pre_st_pre_pe) AS pre_st_pre_pe'
		.', AVG(pre_st_pre_ce) AS pre_st_pre_ce'
		.', AVG(pre_st_pre_cf) AS pre_st_pre_cf'
		.', AVG(pre_st_pre_re_rm) AS pre_st_pre_re_rm'
		.', AVG(pre_st_pre_re_ce) AS pre_st_pre_re_ce'
		.', AVG(pre_st_pre_re_cf) AS pre_st_pre_re_cf'
		...
		.', SUM('.$_data_pre_st_re_endo.') AS pre_st_re_endo'
