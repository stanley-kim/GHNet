<div id="consv_list" class="khusd_st list consv">
	학번 입력: 
	<input id="id_input" type=text name="st_id" value="<?=$st_id?>">
	<input type="button" onClick="searchID();" value=검색 />
	<script>
		function searchID(){
			window.location.href = "http://kd45th.kimsq.co.kr/?r=home&m=khusd_st_consv&mode=history_search&st_id="+$("#id_input").val();
		}
		
	</script>
	<h3>보존과 OP 점수표 - <?=$st_id?></h3> 
