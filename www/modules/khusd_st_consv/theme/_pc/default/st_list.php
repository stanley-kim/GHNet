...
<!--		<th scope="col" class="split"><a href="<?php echo getSortingLink($c, '', $om)?>">OP 체어 당첨 횟수</a></th> -->
		...
		<th scope="col" class="split"><a href="<?php echo getSortingLink($c, 'st_op_prev_score', $om)?>">이월OP점수</a></th>
...
<!--		<th scope="col" class="split">OP 체어 당첨 횟수</th>-->
		...
		<th scope="col" class="split">이월OP점수</th>
		...
		<th scope="col" class="split">이번-이월OP점수</th>
