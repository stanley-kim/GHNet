...
<!--		<th scope="col" class="split"><a href="<?php echo getSortingLink($c, '', $om)?>">OP 체어 당첨 횟수</a></th> -->
		...
		<th scope="col" class="split"><a href="<?php echo getSortingLink($c, 'st_endo_2nd_point', $om)?>">Endo점수(2nd case)</a></th>
		<th scope="col" class="split"><a href="<?php echo getSortingLink($c, 'st_op_bleaching', $om)?>">Blch</a></th>
		<th scope="col" class="split"><a href="<?php echo getSortingLink($c, 'st_op_prev_score', $om)?>">이전학기이월OP점수</a></th>
		...
		<th scope="col" class="split"><a href="<?php echo getSortingLink($c, 'st_op_score', $om)?>">이번학기OP점수</a></th>
		<th scope="col" class="split"><a href="<?php echo getSortingLink($c, 'st_op_prev_cur_score', $om)?>">이번-이월OP점수</a></th>
...
<!--		<th scope="col" class="split">OP 체어 당첨 횟수</th>-->
		...
		<th scope="col" class="split">Endo점수(2nd case)</th>
		<th scope="col" class="split">Blch</th>
		<th scope="col" class="split">이전학기이월OP점수</th>
		...
		<th scope="col" class="split">이번학기OP점수</th>
		<th scope="col" class="split">이번-이월P점수</th>
...
<!--		<th scope="col" class="split">팔로우총점</th>
	...
	<tr>
		...
		<td class="avg"><?php echo sprintf("%01.2f",$AVG['st_op_prev_score'])?></td>
		...
		<td class="avg"><?php echo sprintf("%01.2f",$AVG['st_op_prev_cur_score'])?></td>
...
<!--	<td class="category3"><?php echo $SCORE['st_op_chair_assigned']?></td>-->
	...
	<td class="category1"><?php echo $SCORE['st_op_prev_score']?></td>
	...
	<td><?php echo sprintf("%01.2f",$SCORE['st_op_prev_cur_score'])?></td>
